(function() {
    ...
    function init() {
        ...
        DOM.brainwallet.on("input", brainWalletChanged);
    ...
    function brainWalletChanged() {
        DOM.phrase.val("");
        if (DOM.brainwallet.val().length < 24) {
            showValidationError("Meta Code is too short to keep your assets safe!");
            return;
        }
        showPending();
        setMnemonicLanguage();
